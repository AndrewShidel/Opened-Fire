...
function game(up, down, left, right){
	...
	crosshairs.src = "http://www.openedfire.com/img/Decals/Crosshair.png";
	
	pattern = new Image();
	pattern.src = "http://www.openedfire.com/img/Map/Map.png";
	
	zimg = new Image();
	zimg.src = "http://www.openedfire.com/img/Zombie/Zombie.png";
	
	zimg2 = new Image();
	zimg2.src = "http://www.openedfire.com/img/Zombie/Zombie2.gif";
	
	zimg3 = new Image();
	zimg3.src = "http://www.openedfire.com/img/Zombie/Zombie3.gif";
	
	playerImage = new Image();
	playerImage.src =  "http://www.openedfire.com/img/Human808/808.png";
	
	playerImg2 = new Image();
	playerImg2.src =  "http://www.openedfire.com/img/Human71-M/Ti-M.png";
	...
	box = new Image();
	box.src = "http://www.openedfire.com/img/Decals/Ingot.png";
	
	blood = new Image();
	blood.src = "http://www.mudandblood.net/wiki/images/1/1f/Blood_splatter.png";
	
	bomb = new Image();
	bomb.src = "http://www.openedfire.com/img/Decals/Mine.png"
